...
const Sidebar = () => (
  <div className="nav-bar">
    ...
    <nav>
      ...
      <NavLink className="abouticon" exact="true" activeclassname="active" to="/about">
        <FontAwesomeIcon icon={faUser} color="#4d4de" />
      </NavLink>
      <NavLink className="contacticon "exact="true" activeclassname="active" to="/contact">
        <FontAwesomeIcon icon={faEnvelope} color="#4d4de" />
      </NavLink>
      <NavLink className="portfolioicon "exact="true" activeclassname="active" to="/portfolio">
        <FontAwesomeIcon icon={faBriefcase} color="#4d4de" />
      </NavLink>
    </nav>
    <ul>
      <li>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://www.linkedin.com/in/victorgarridorojas/"
        >
      ...
      <li>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://github.com/victorgarrido1"
        >
      ...
      <li>
        <a
          target="_blank"
          rel="noreferrer"
          href="https://www.youtube.com/@victorgarridofilms"
        >
